...
import (
	...
	externalversions "knative.dev/networking/pkg/client/service-apis/informers/externalversions"
	client "knative.dev/networking/pkg/client/service-apis/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/networking/pkg/client/service-apis/informers/externalversions.SharedInformerFactory from context.")
	}
