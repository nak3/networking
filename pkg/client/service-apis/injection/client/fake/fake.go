...
import (
	...
	fake "knative.dev/networking/pkg/client/service-apis/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/networking/pkg/client/service-apis/clientset/versioned/fake.Clientset from context.")
	}
